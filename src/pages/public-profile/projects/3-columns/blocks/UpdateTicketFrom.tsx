...
const UpdateTicketForm = () => {
	...
	return (
		<Container>
			<MenuLabel className="mb-3.5">Update Ticket</MenuLabel>
			<div className="card max-w-full w-full">
				<form className="card-body gap-5 p-10">
					...
					<div className="flex flex-row gap-2 mt-5 max-w-12 ">
						<Button type="submit" className="btn btn-primary flex justify-right grow">
							Create Ticket
						</Button>
					</div>
				</form>
