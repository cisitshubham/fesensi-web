...
const options = {
  ...
  supportSLA: [
    'Standard (Email within 72 hrs)',
    'Priority (Email within 24 hrs)',
...
function SideTabs({
  ...
  return (
    <div className="flex flex-col px-4  gap-1  pr-4 border-r h-full sticky top-0">
      {tabs.map((tab) => (
        <Button
          key={tab}
          variant={activeTab === tab ? 'default' : 'ghost'}
          className="justify-start text-left px-4 py-2 rounded-lg font-medium transition-colors duration-200"
...
export default function SimplifiedPermissions() {
  ...
  const [activeTab, setActiveTab] = useState('Validity & Access');
    ...
    <div className="mx-auto p-6">
      <Card className="shadow-sm">
        ...
        <div className="flex flex-row min-h-[600px]">
          {/* Side Tabs */}
          <SideTabs tabs={tabList} activeTab={activeTab} onTabChange={setActiveTab} />
          {/* Main Content */}
          <div className="flex-1 pl-0 lg:pl-8">
            <div className="py-2">
              {activeTab === 'Validity & Access' && (
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <Popover open={datePopoverOpen} onOpenChange={setDatePopoverOpen}>
                        <PopoverTrigger asChild>
                          ...
                          >
                            {config.validity
                              ? format(config.validity, 'LLL dd, y')
                              : 'Pick expiry date'}
                          </button>
                        </PopoverTrigger>
                          ...
                          <label key={opt} className="flex items-center gap-2">
                            <Checkbox
                              ...
                              onCheckedChange={(v: boolean) =>
                                handleCheckboxChange('accessType', opt)
                              }
                            />
                            {opt}
                          </label>
              ...
              {activeTab === 'User & Platform Limits' && (
                <Card className="shadow-sm mb-4">
                  <CardHeader>
                        ...
                        {options.platforms.map((opt) => (
                          <label key={opt} className="flex items-center gap-2">
                            <Checkbox
                              ...
                              onCheckedChange={(v: boolean) =>
                                handleCheckboxChange('availablePlatforms', opt)
                              }
                            />
                            {opt}
                          </label>
              ...
              {activeTab === 'Knowledge Base & Department' && (
                <Card className="shadow-sm mb-4">
                  <CardHeader>
                        ...
                        {options.supportChannels.map((opt) => (
                          <label key={opt} className="flex items-center gap-2">
                            <Checkbox
                              ...
                              onCheckedChange={(v: boolean) =>
                                handleCheckboxChange('supportChannels', opt)
                              }
                            />
                            {opt}
                          </label>
