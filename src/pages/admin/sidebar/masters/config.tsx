  ...
  return (
    <div className="flex border-b mb-6 gap-2 overflow-x-auto ">
      {tabs.map((tab) => (
        <button
          key={tab}
          className={`px-4 py-2 font-sm  border-b-2 transition-colors duration-200 ${activeTab === tab ? 'border-primary text-primary' : 'border-transparent text-gray-500 hover:text-primary'}`}
